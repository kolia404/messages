...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <div className="flex md:hidden fixed inset-0 z-[99999] bg-[#020617] flex-col items-center justify-center p-8 text-center text-white" dir="rtl">
        <motion.div 
      ...
      <div 
        className="hidden md:flex min-h-screen bg-[#f8fafc] font-sans overflow-hidden" 
        dir="rtl"
